...
def prepare_datasets(test_size, validation_size):
    ...
    with open("mappings.json", "w") as mp:
        json.dump(z, mp)
...
# save trained model and corresponding weights to disk
def save_model(model):

    with open("trained_model.json", "w") as tm:
        tm.write(model.to_json())
